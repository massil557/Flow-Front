  ...
  return (
    <div 
      ...
      className={`relative cursor-pointer rounded-xl border-2 p-4 transition-all duration-200 hover:shadow-md ${
        isOverThreshold ? 'border-red-200 bg-red-50/30' : 'border-slate-100 bg-white'
      }`}
    >
      <div className="flex items-start justify-between">
        ...
        {trendValue !== undefined && (
          <div className={`flex items-center gap-0.5 rounded-full bg-slate-50 px-1.5 py-0.5 text-xs font-medium ${trendColor}`}>
